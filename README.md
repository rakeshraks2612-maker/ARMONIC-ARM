...
Benchmarked on AWS EC2 c7g.xlarge (Graviton3, Neoverse V1) running Ubuntu 22.04 Arm64 with Arm Performix (APX) hardware performance counters.
...
2.5-minute demo of autonomous optimization on AWS Graviton Arm64: [YouTube link]
